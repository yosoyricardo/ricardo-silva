...
export default function Menu() {
    ...
    return <nav className="flex items-center">
        <ul className={`z-40 flex w-full items-center justify-center transition duration-300 ease-in-out fixed md:static bg-black md:bg-transparent left-[0px] top-[55px] bottom-[0] md:flex flex-col md:flex-row items-start md:item-center gap-6 text-gray-600  md:flex ${open ? "visible translate-x-[0%]": "translate-x-[-100%] md:translate-x-[-0%]"}`}>
            {menuList.map(item => (
